<?php
	/*
		Template Name: Member Password Reset Page
	*/
?>
...
<div class="main-container">
	<div class="section w600 center">
		<h1 class="fs45">Reset your password</h1>
		<p>Enter the following information to reset your password.</p>
...
(function ($){
	...
	$('.main-container .submit').on('click', function(event) {
		...
		.done(function(res) {
			console.log(res);
			if (res == "success") {
				window.location.href = "/dental-plans-password-confirmation";
			} else {
