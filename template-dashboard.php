  ...
  <div class="dashboard">
    <div class="row">
      <div class="four columns">
        <div class="tab-box">
          <div class="item tab-profile <?php if ($tab === 'profile') { echo 'active'; } ?>"><a href="/user-dashboard/?tab=profile">PROFILE</a></div>
          <div class="item tab-payment <?php if ($tab === 'payment') { echo 'active'; } ?>"><a href="/user-dashboard/?tab=payment">PAYMENT</a></div>
          <div class="item tab-password <?php if ($tab === 'password') { echo 'active'; } ?>"><a href="/user-dashboard/?tab=password">PASSWORD</a></div>
          <div class="item tab-refer <?php if ($tab === 'refer') { echo 'active'; } ?>"><a href="/user-dashboard/?tab=refer">REFER A FRIEND</a></div>
        </div>
      </div>
      <div class="eight columns">
        <div class="profile-box">
          <div class="section-1 <?php if ($tab === 'profile') echo 'visible'; ?>" >
            <div class="twelve columns">
              <div class="row">
        ...
        <div class="profile-payment twelve columns">
          <div class="section-1 <?php if ($tab === 'payment') { echo 'visible'; } ?>">
            <div class="row">
              <div class="six columns dfd_col-mobile-6">
                <p>Membership Type: </p>
              </div>
        ...
        <div class="profile-password twelve columns">
          <div class="edit-password <?php if ($tab === 'password') { echo 'visible'; } ?>">
        ...
        <div class="section profile-refer-box twelve columns">
          <div class="refer-box <?php if ($tab === 'refer') { echo 'visible'; } ?>">
